...
add_filter( 'allowed_block_types', 'reconasia_keep_plugins_blocks', 10, 2 );

// Add `csis-block` class to all blocks
function reconasia_lzb_block_render_attributes( $attributes, $content, $block, $context ) {
...
add_filter( 'lazyblock/post-image/attributes', 'reconasia_lzb_block_post_image_render_attributes', 10, 4 );


// Create Handlebars Helper for Images
function reconasia_lazyblock_handlebars_helper_img ( $handlebars ) {
...
add_action( 'lzb/handlebars/object', 'reconasia_lazyblock_handlebars_helper_img' );

// Create Handlebars Helper for Image Source
function reconasia_lazyblock_handlebars_helper_img_source ( $handlebars ) {
...
add_action( 'lzb/handlebars/object', 'reconasia_lazyblock_handlebars_helper_img_source' );
